...
function updateFilter(value, options = {}) {
  var filterId = options.filterId || '0';
  if (!this.data.__filteredValues) {
    this.data.__filteredValues = {};
  }
  ...
  this.data.__filteredValues[parsedKey] = value;
}
