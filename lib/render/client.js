...
Regular.implement({
  ...
  _handleEvent: function(elem, type, value, attrs){
    ...
    if (!this.__eventHandlers[eventId]) {
      this.__eventHandlers[eventId] = {}
    }
    this.__eventHandlers[eventId][type] = value;
    return function() {}
  },
  // 1. 用来处理exprBody -> Function
  // 2. list里的循环
  _touchExpr: function(expr, ext){
    var rawget, ext = this.__ext__, touched = {}, expressions = this.expressions;
...
Regular.prototype.proxyEvent = mp.proxyEvent;
