...
walkers.element = function(ast, options){
  ...
  var destroies = walkAttributes.call(this, attrs, element, extra, eventId);
...
function walkAttributes(attrs, element, extra, eventId){
  var bindings = []
  for(var i = 0, len = attrs.length; i < len; i++){
    var binding = this._walk(attrs[i], {element: element, fromElement: true, attrs: attrs, extra: extra, eventId: eventId})
